...
class ExampleInitializeGazeboRobot(object):
    ...
    def __init__(self):
        ...
        try:
            self.robot_name = rospy.get_param("~robot_name", default="JK_01")
...
def main():
    try:
        ...
        try:
            ...
            is_paused = rospy.ServiceProxy("/gazebo/get_physics_properties", GetPhysicsProperties)
            resp = is_paused()
            if resp.pause:
                # Unpause the physics
            ...
            rospy.logerr("No Gazebo Property Service")
        print("Initializing Gazebo Robot...")
